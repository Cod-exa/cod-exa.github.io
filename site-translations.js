(function () {
  ...
  Object.assign(window.PAGE_TRANSLATIONS, {
    ...
    one_ecosystem:{tr:'Tek bir ekosistemde',en:'In one ecosystem'},published_count:{tr:'15 yayında',en:'15 published'},growing_family:{tr:'gelişen ürün ailesi',en:'growing product family'},language_count:{tr:'15 dil',en:'15 languages'},accessible_content:{tr:'erişilebilir içerik',en:'accessible content'},area_count:{tr:'4 alan',en:'4 areas'},domain_list:{tr:'öğrenme, odak ve yönetim',en:'learning, focus, and management'},
  ...
  const localizedExtras={
    de:[
      ...
      'In einem Ökosystem','15 veröffentlicht','wachsende Produktfamilie','15 Sprachen','barrierefreie Inhalte','4 Bereiche','Lernen, Fokus und Verwaltung',
    ...
    zh:[
      ...
      '一个完整生态','15 款已发布','持续成长的产品家族','15 种语言','无障碍内容','4 个领域','学习、专注与管理',
    ...
    hi:[
      ...
      'एक ही तंत्र में','15 प्रकाशित','बढ़ता उत्पाद परिवार','15 भाषाएँ','सुलभ सामग्री','4 क्षेत्र','सीखना, एकाग्रता और प्रबंधन',
    ...
    es:[
      ...
      'En un solo ecosistema','15 publicados','familia de productos en crecimiento','15 idiomas','contenido accesible','4 áreas','aprendizaje, concentración y gestión',
    ...
    fr:[
      ...
      'Dans un seul écosystème','15 publiés','gamme de produits en croissance','15 langues','contenu accessible','4 domaines','apprentissage, concentration et gestion',
    ...
    ar:[
      ...
      'في منظومة واحدة','15 منتجًا منشورًا','عائلة منتجات متنامية','15 لغة','محتوى سهل الوصول','4 مجالات','التعلّم والتركيز والإدارة',
    ...
    pt:[
      ...
      'Em um único ecossistema','15 publicados','família de produtos em expansão','15 idiomas','conteúdo acessível','4 áreas','aprendizagem, foco e gestão',
    ...
    ru:[
      ...
      'В единой экосистеме','15 опубликовано','растущая линейка продуктов','15 языков','доступный контент','4 направления','обучение, внимание и управление',
    ...
    id:[
      ...
      'Dalam satu ekosistem','15 diterbitkan','keluarga produk yang berkembang','15 bahasa','konten yang mudah diakses','4 bidang','pembelajaran, fokus, dan pengelolaan',
    ...
    bn:[
      ...
      'একটি ব্যবস্থায়','15টি প্রকাশিত','বিকাশমান পণ্য পরিবার','15টি ভাষা','সহজলভ্য বিষয়বস্তু','4টি ক্ষেত্র','শিক্ষা, মনোযোগ ও ব্যবস্থাপনা',
    ...
    ur:[
      ...
      'ایک ہی نظام میں','15 شائع شدہ','بڑھتا ہوا پروڈکٹ خاندان','15 زبانیں','قابلِ رسائی مواد','4 شعبے','تعلیم، توجہ اور انتظام',
    ...
    ja:[
      ...
      '一つのエコシステムで','15 製品を公開','成長する製品群','15 言語','アクセシブルなコンテンツ','4 領域','学習・集中・管理',
    ...
    ko:[
      ...
      '하나의 생태계에서','15개 출시','성장하는 제품군','15개 언어','접근 가능한 콘텐츠','4개 영역','학습, 집중 및 관리',
