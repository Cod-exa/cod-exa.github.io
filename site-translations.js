(function () {
  ...
  const localizedExtras={
    de:[
      'Spielerisches Lernen','Mehrsprachiges Erlebnis','Mobile-First','System aktiv','Lerninteraktion','Produktökosystem','20<small> Produkte</small>','Lernbereiche','Logik','aktiv','Mathematik','Fokus',
    ...
    zh:[
      '游戏化学习','多语言体验','移动优先','系统运行中','学习互动','产品生态','20<small> 款产品</small>','学习领域','逻辑','运行中','数学','专注',
    ...
    hi:[
      'खेल-आधारित सीखना','बहुभाषी अनुभव','मोबाइल-प्रथम','सिस्टम सक्रिय','सीखने की सहभागिता','उत्पाद तंत्र','20<small> उत्पाद</small>','सीखने के क्षेत्र','तर्क','सक्रिय','गणित','एकाग्रता',
    ...
    es:[
      'Aprendizaje gamificado','Experiencia multilingüe','Diseño móvil primero','Sistema activo','Interacción de aprendizaje','Ecosistema de productos','20<small> productos</small>','Áreas de aprendizaje','Lógica','activo','Matemáticas','Concentración',
    ...
    fr:[
      'Apprentissage ludifié','Expérience multilingue','Priorité au mobile','Système actif','Interaction pédagogique','Écosystème de produits','20<small> produits</small>','Domaines pédagogiques','Logique','actif','Mathématiques','Concentration',
    ...
    ar:[
      'التعلّم بالألعاب','تجربة متعددة اللغات','تصميم للجوال أولاً','النظام نشط','التفاعل التعليمي','منظومة المنتجات','20<small> منتجًا</small>','مجالات التعلّم','المنطق','نشط','الرياضيات','التركيز',
    ...
    pt:[
      'Aprendizagem gamificada','Experiência multilíngue','Prioridade para dispositivos móveis','Sistema ativo','Interação de aprendizagem','Ecossistema de produtos','20<small> produtos</small>','Áreas de aprendizagem','Lógica','ativo','Matemática','Foco',
    ...
    ru:[
      'Игровое обучение','Многоязычный интерфейс','Приоритет мобильным устройствам','Система активна','Учебное взаимодействие','Экосистема продуктов','20<small> продуктов</small>','Области обучения','Логика','активно','Математика','Внимание',
    ...
    id:[
      'Pembelajaran berbasis permainan','Pengalaman multibahasa','Utamakan perangkat seluler','Sistem aktif','Interaksi pembelajaran','Ekosistem produk','20<small> produk</small>','Bidang pembelajaran','Logika','aktif','Matematika','Fokus',
    ...
    bn:[
      'গেমভিত্তিক শিক্ষা','বহুভাষিক অভিজ্ঞতা','মোবাইল-প্রথম','সিস্টেম সক্রিয়','শেখার মিথস্ক্রিয়া','পণ্য ব্যবস্থা','20<small>টি পণ্য</small>','শেখার ক্ষেত্র','যুক্তি','সক্রিয়','গণিত','মনোযোগ',
    ...
    ur:[
      'کھیل کے ذریعے تعلیم','کثیر لسانی تجربہ','موبائل اوّل','نظام فعال','تعلیمی تعامل','مصنوعات کا نظام','20<small> مصنوعات</small>','تعلیمی شعبے','منطق','فعال','ریاضی','توجہ',
    ...
    ja:[
      'ゲーミフィケーション学習','多言語体験','モバイルファースト','システム稼働中','学習エンゲージメント','製品エコシステム','20<small> 製品</small>','学習領域','論理','稼働中','数学','集中',
    ...
    ko:[
      '게임 기반 학습','다국어 경험','모바일 우선','시스템 활성','학습 참여','제품 생태계','20<small>개 제품</small>','학습 영역','논리','활성','수학','집중',
  ...
  const productNames={
    ...
    zh:['2048 - 数字益智游戏','骑士巡游：益智游戏','乘法表','Math Meadow','数和','KenKen 逻辑：益智谜题','视觉计时器：专注','Nim Master','播棋游戏','汉诺塔：神庙谜题','骑士巡游','VouchKeep：收据与保修','ScreenRecall：屏幕截图','Stacking Balance','Resonant','Classtings','像素花园','磁力迷宫','Nexus: Oathbound Realms','Grid Heist Vault Breaker'],
    hi:['2048 - संख्या पहेली खेल','नाइट टूर: दिमागी खेल','गुणा तालिका','Math Meadow','काकुरो','KenKen Logic: दिमागी पहेली','विज़ुअल टाइमर: फोकस','Nim Master','मंगला खेल','हनोई टॉवर: मंदिर पहेली','नाइट टूर','VouchKeep: रसीदें और वारंटी','ScreenRecall: स्क्रीनशॉट','Stacking Balance','Resonant','Classtings','पिक्सेल गार्डन','चुंबकीय भूलभुलैया','नेक्सस: ओथबाउंड रियल्म्स','ग्रिड हीस्ट वॉल्ट ब्रेकर'],
    es:['2048 - Juego de números','Recorrido del caballo: Juego mental','Tablas de multiplicar','Math Meadow','Kakuro','KenKen Logic: Rompecabezas mental','Temporizador visual: Concentración','Nim Master','Juego de Mangala','Torre de Hanói: Puzzle del templo','Recorrido del caballo','VouchKeep: Recibos y garantía','ScreenRecall: Capturas de pantalla','Stacking Balance','Resonant','Classtings','Jardín de píxeles','Laberinto magnético','Nexus: Oathbound Realms','Grid Heist Vault Breaker'],
    ...
    ar:['2048 - لعبة ألغاز الأرقام','جولة الحصان: لعبة ذهنية','جدول الضرب','Math Meadow','كاكورو','KenKen Logic: لغز ذهني','المؤقت المرئي: التركيز','Nim Master','لعبة المنقلة','برج هانوي: لغز المعبد','جولة الحصان','VouchKeep: الإيصالات والضمان','ScreenRecall: لقطات الشاشة','Stacking Balance','Resonant','Classtings','حديقة البكسل','المتاهة المغناطيسية','Nexus: Oathbound Realms','Grid Heist Vault Breaker'],
    ...
    bn:['2048 - সংখ্যার ধাঁধা','নাইট ট্যুর: মস্তিষ্কের খেলা','নামতা','Math Meadow','কাকুরো','KenKen Logic: মস্তিষ্কের ধাঁধা','ভিজ্যুয়াল টাইমার: মনোযোগ','Nim Master','মাঙ্গালা খেলা','হ্যানয় টাওয়ার: মন্দিরের ধাঁধা','নাইট ট্যুর','VouchKeep: রসিদ ও ওয়ারেন্টি','ScreenRecall: স্ক্রিনশট','Stacking Balance','Resonant','Classtings','পিক্সেল গার্ডেন','চৌম্বক গোলকধাঁধা','নেক্সাস: ওথবাউন্ড রিয়েলমস','গ্রিড হেইস্ট ভল্ট ব্রেকার'],
    ...
    ja:['2048 - 数字パズルゲーム','ナイトツアー：脳トレゲーム','かけ算九九','Math Meadow','カックロ','KenKen Logic：脳トレパズル','ビジュアルタイマー：集中','Nim Master','マンカラゲーム','ハノイの塔：神殿パズル','ナイトツアー','VouchKeep：レシート＆保証','ScreenRecall：スクリーンショット','Stacking Balance','Resonant','Classtings','ピクセルガーデン','マグネット迷路','Nexus: Oathbound Realms','Grid Heist Vault Breaker'],
    ko:['2048 - 숫자 퍼즐 게임','나이트 투어: 두뇌 게임','구구단','Math Meadow','가쿠로','KenKen Logic: 두뇌 퍼즐','비주얼 타이머: 집중','Nim Master','만칼拉 게임','하노이 탑: 사원 퍼즐','나이트 투어','VouchKeep: 영수증 및 보증','ScreenRecall: 스크린샷','Stacking Balance','Resonant','Classtings','픽셀 가든','자기 미로','넥서스: 오스바운드 렐름','그리드 하이스트 볼트 브레이커']
  };
