(function () {
  ...
  Object.assign(window.PAGE_TRANSLATIONS, {
    product_tek_tas:{tr:'Tek Taş: Peg Solitaire',en:'Tek Tas: Peg Solitaire',de:'Tek Taş: Peg Solitaire',zh:'Tek Taş：跳棋谜题',hi:'टेक ताश: पेग सॉलिटेयर',es:'Tek Taş: Peg Solitaire',fr:'Tek Taş : Peg Solitaire',ar:'Tek Taş: أحجية القفز',pt:'Tek Taş: Peg Solitaire',ru:'Tek Taş: Пег-солитер',id:'Tek Taş: Peg Solitaire',bn:'টেক তাশ: পেগ সলিটেয়ার',ur:'Tek Taş: پیگ سولٹیئر',ja:'Tek Taş：ペグソリティア',ko:'Tek Taş: 페그 솔리테어'},
    ...
    tek_tas_deletion:{tr:'Tek Taş — Hesap ve Veri Silme',en:'Tek Tas — Account & Data Deletion',de:'Tek Taş — Konto- und Datenlöschung',zh:'Tek Taş — 账户与数据删除',hi:'Tek Taş — खाता और डेटा हटाना',es:'Tek Taş — Eliminación de cuenta y datos',fr:'Tek Taş — Suppression du compte et des données',ar:'Tek Taş — حذف الحساب والبيانات',pt:'Tek Taş — Exclusão de conta e dados',ru:'Tek Taş — Удаление аккаунта и данных',id:'Tek Taş — Penghapusan akun & data',bn:'Tek Taş — অ্যাকাউন্ট ও ডেটা মুছুন',ur:'Tek Taş — اکاؤنٹ اور ڈیٹا حذف کریں',ja:'Tek Taş — アカウントとデータの削除',ko:'Tek Taş — 계정 및 데이터 삭제'}
  });  Object.assign(window.PAGE_TRANSLATIONS, {
