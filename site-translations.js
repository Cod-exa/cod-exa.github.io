(function () {
  ...
  const localizedExtras={
    de:[
      'Spielerisches Lernen','Mehrsprachiges Erlebnis','Mobile-First','System aktiv','Lerninteraktion','Produktökosystem','21<small> Produkte</small>','Lernbereiche','Logik','aktiv','Mathematik','Fokus',
    ...
    zh:[
      '游戏化学习','多语言体验','移动优先','系统运行中','学习互动','产品生态','21<small> 款产品</small>','学习领域','逻辑','运行中','数学','专注',
    ...
    hi:[
      'खेल-आधारित सीखना','बहुभाषी अनुभव','मोबाइल-प्रथम','सिस्टम सक्रिय','सीखने की सहभागिता','उत्पाद तंत्र','21<small> उत्पाद</small>','सीखने के क्षेत्र','तर्क','सक्रिय','गणित','एकाग्रता',
    ...
    es:[
      'Aprendizaje gamificado','Experiencia multilingüe','Diseño móvil primero','Sistema activo','Interacción de aprendizaje','Ecosistema de productos','21<small> productos</small>','Áreas de aprendizaje','Lógica','activo','Matemáticas','Concentración',
    ...
    fr:[
      'Apprentissage ludifié','Expérience multilingue','Priorité au mobile','Système actif','Interaction pédagogique','Écosystème de produits','21<small> produits</small>','Domaines pédagogiques','Logique','actif','Mathématiques','Concentration',
    ...
    ar:[
      'التعلّم بالألعاب','تجربة متعددة اللغات','تصميم للجوال أولاً','النظام نشط','التفاعل التعليمي','منظومة المنتجات','21<small> منتجًا</small>','مجالات التعلّم','المنطق','نشط','الرياضيات','التركيز',
    ...
    pt:[
      'Aprendizagem gamificada','Experiência multilíngue','Prioridade para dispositivos móveis','Sistema ativo','Interação de aprendizagem','Ecossistema de produtos','21<small> produtos</small>','Áreas de aprendizagem','Lógica','ativo','Matemática','Foco',
    ...
    ru:[
      'Игровое обучение','Многоязычный интерфейс','Приоритет мобильным устройствам','Система активна','Учебное взаимодействие','Экосистема продуктов','21<small> продуктов</small>','Области обучения','Логика','активно','Математика','Внимание',
    ...
    id:[
      'Pembelajaran berbasis permainan','Pengalaman multibahasa','Utamakan perangkat seluler','Sistem aktif','Interaksi pembelajaran','Ekosistem produk','21<small> produk</small>','Bidang pembelajaran','Logika','aktif','Matematika','Fokus',
    ...
    bn:[
      'গেমভিত্তিক শিক্ষা','বহুভাষিক অভিজ্ঞতা','মোবাইল-প্রথম','সিস্টেম সক্রিয়','শেখার মিথস্ক্রিয়া','পণ্য ব্যবস্থা','21<small>টি পণ্য</small>','শেখার ক্ষেত্র','যুক্তি','সক্রিয়','গণিত','মনোযোগ',
    ...
    ur:[
      'کھیل کے ذریعے تعلیم','کثیر لسانی تجربہ','موبائل اوّل','نظام فعال','تعلیمی تعامل','مصنوعات کا نظام','21<small> مصنوعات</small>','تعلیمی شعبے','منطق','فعال','ریاضی','توجہ',
    ...
    ja:[
      'ゲーミフィケーション学習','多言語体験','モバイルファースト','システム稼働中','学習エンゲージメント','製品エコシステム','21<small> 製品</small>','学習領域','論理','稼働中','数学','集中',
    ...
    ko:[
      '게임 기반 학습','다국어 경험','모바일 우선','시스템 활성','학습 참여','제품 생태계','21<small>개 제품</small>','학습 영역','논리','활성','수학','집중',
