(function () {
  ...
  Object.assign(window.PAGE_TRANSLATIONS, {
    product_tek_tas:{tr:'Tek Taş: Taş Atlama Bulmacası',en:'Peg Solitaire',de:'Englisches Solitär',zh:'单人跳棋',hi:'पेग सॉलिटेयर',es:'Solitario de clavijas',fr:'Solitaire anglais',ar:'سوليتير القفز',pt:'Resta Um',ru:'Английский солитер',id:'Solitaire Pasak',bn:'পেগ সলিটেয়ার',ur:'پیگ سولیٹیئر',ja:'ペグ・ソリティア',ko:'페그 솔리테어'},
    ...
    tek_tas_deletion:{tr:'Tek Taş — Hesap ve Veri Silme',en:'Peg Solitaire — Account & Data Deletion',de:'Englisches Solitär — Konto- und Datenlöschung',zh:'单人跳棋 — 账户与数据删除',hi:'पेग सॉलिटेयर — खाता और डेटा हटाना',es:'Solitario de clavijas — Eliminación de cuenta y datos',fr:'Solitaire anglais — Suppression du compte et des données',ar:'سوليتير القفز — حذف الحساب والبيانات',pt:'Resta Um — Exclusão de conta e dados',ru:'Английский солитер — Удаление аккаунта и данных',id:'Solitaire Pasak — Penghapusan akun & data',bn:'পেগ সলিটেয়ার — অ্যাকাউন্ট ও ডেটা মুছুন',ur:'پیگ سولیٹیئر — اکاؤنٹ اور ڈیٹا حذف کریں',ja:'ペグ・ソリティア — アカウントとデータの削除',ko:'페그 솔리테어 — 계정 및 데이터 삭제'}
  });  Object.assign(window.PAGE_TRANSLATIONS, {
