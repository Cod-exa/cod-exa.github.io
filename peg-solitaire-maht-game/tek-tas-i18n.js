(function () {
  ...
  const shared = {
    ...
    tek_tas_legal_marker: {
      tr: 'Peg Solitaire Maht Game', en: 'Peg Solitaire Maht Game', de: 'Peg Solitaire Maht Game',
      zh: 'Peg Solitaire Maht Game', hi: 'Peg Solitaire Maht Game', es: 'Peg Solitaire Maht Game',
      fr: 'Peg Solitaire Maht Game', ar: 'Peg Solitaire Maht Game', pt: 'Peg Solitaire Maht Game',
      ru: 'Peg Solitaire Maht Game', id: 'Peg Solitaire Maht Game', bn: 'Peg Solitaire Maht Game',
      ur: 'Peg Solitaire Maht Game', ja: 'Peg Solitaire Maht Game', ko: 'Peg Solitaire Maht Game'
    }
  };
