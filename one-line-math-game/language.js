/**
 * One Line Math Game page language behavior.
...
(() => {
  ...
  const HOME_PATH = /\/one-line-math-game\/(?:index\.html)?$/;
  ...
  function syncLanguagePicker() {
    ...
    if (!menu.id) menu.id = 'one-line-math-language-menu';
  ...
  function applyLanguage(value) {
    ...
    const productNames = window.PAGE_TRANSLATIONS?.one_line_math_legal_marker || {};
    const productName = productNames[lang] || productNames.en || 'One Line Math Game';
