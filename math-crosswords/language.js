/**
 * Math Crosswords page language behavior.
...
(() => {
  ...
  const HOME_PATH = /\/math-crosswords\/(?:index\.html)?$/;
  ...
  function syncLanguagePicker() {
    ...
    if (!menu.id) menu.id = 'math-crosswords-language-menu';
  ...
  function applyLanguage(value) {
    ...
    const productNames = window.PAGE_TRANSLATIONS?.math_crosswords_legal_marker || {};
    const productName = productNames[lang] || productNames.en || 'Math Crosswords: Number Atlas';
